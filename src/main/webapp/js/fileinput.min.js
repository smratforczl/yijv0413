...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, v, h, w, b, _, C, y, x, T, I, P, F, E, k, S, A, z, D, M, $, U,
                j, R, O, B, L, N, Z = this;
            i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="input-group {class}">\n  {caption}\n<div class="input-group-btn input-group-append">\n      {remove}\n      {cancel}\n      {pause}\n      {upload}\n      {browse}\n    </div>\n</div>', a = '{preview}\n<div class="kv-upload-progress kv-hidden"></div>\n<div class="clearfix"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n', r = '<div class="file-preview {class}">\n    {close}    <div class="{dropClass}">\n    <div class="file-preview-thumbnails">\n    </div>\n    <div class="clearfix"></div>    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n    </div>\n</div>', o = t.closeButton("fileinput-remove"), n = '<i class="glyphicon glyphicon-file"></i>', l = '<div class="file-caption form-control {class}" tabindex="500">\n  <span class="file-caption-icon"></span>\n  <input class="file-caption-name" onkeydown="return false;" onpaste="return false;">\n</div>', s = '<button type="{type}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</button>', d = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>', c = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>', u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + t.MODAL_ID + 'Label"></div>', p = '<div class="modal-dialog modal-lg{rtl}" role="document">\n  <div class="modal-content">\n    <div class="modal-header">\n      <h5 class="modal-title">{heading}</h5>\n      <span class="kv-zoom-title"></span>\n      <div class="kv-zoom-actions">{toggleheader}{fullscreen}{borderless}{close}</div>\n    </div>\n    <div class="modal-body">\n      <div class="floating-buttons"></div>\n      <div class="kv-zoom-body file-zoom-content {zoomFrameClass}"></div>\n{prev} {next}\n    </div>\n  </div>\n</div>\n', f = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}', N = '<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>', g = " <samp>({sizeText})</samp>", m = '<div class="file-thumbnail-footer">\n    <div class="file-footer-caption" title="{caption}">\n        <div class="file-caption-info">{caption}</div>\n        <div class="file-size-info">{size}</div>\n    </div>\n    {progress}\n{indicator}\n{actions}\n</div>', v = '<div class="file-actions">\n    <div class="file-footer-buttons">\n        {download} {upload} {delete} {zoom} {other}    </div>\n</div>\n{drag}\n<div class="clearfix"></div>', h = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n', w = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>', b = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>', _ = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>', C = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>', y = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>', x = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-template="{template}"', T = x + '><div class="kv-file-content">\n', I = x + ' title="{caption}"><div class="kv-file-content">\n', P = "</div>{footer}\n</div>\n", F = "{content}\n", O = " {style}", E = '<div class="kv-preview-data file-preview-html" title="{caption}"' + O + ">{data}</div>\n", k = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" alt="{alt}"' + O + ">\n", S = '<textarea class="kv-preview-data file-preview-text" title="{caption}" readonly' + O + ">{data}</textarea>\n", A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + O + "></iframe>", z = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + O + "></iframe>", D = '<video class="kv-preview-data file-preview-video" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n", M = '<!--suppress ALL --><audio class="kv-preview-data file-preview-audio" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</audio>\n", $ = '<embed class="kv-preview-data file-preview-flash" src="{data}" type="application/x-shockwave-flash"' + O + ">\n", j = '<embed class="kv-preview-data file-preview-pdf" src="{data}" type="application/pdf"' + O + ">\n", U = '<object class="kv-preview-data file-preview-object file-object {typeCss}" data="{data}" type="{type}"' + O + '>\n<param name="movie" value="{caption}" />\n' + t.OBJECT_PARAMS + " " + t.DEFAULT_PREVIEW + "\n</object>\n", R = '<div class="kv-preview-data file-preview-other-frame"' + O + ">\n" + t.DEFAULT_PREVIEW + "\n</div>\n", B = '<div class="kv-zoom-cache" style="display:none">{zoomContent}</div>', L = {
                ...
                height: "100%",
                "min-height": "480px"
            }, Z._isPdfRendered() && (j = Z.pdfRendererTemplate.replace("{renderer}", Z._encodeURI(Z.pdfRendererUrl))), Z.defaults = {
                layoutTemplates: {
                    main1: i,
                    main2: a,
                    preview: r,
                ...
                previewMarkupTags: {tagBefore1: T, tagBefore2: I, tagAfter: P},
                    ...
                    var n, o, l, s, d, c, u, p = t.INIT_FLAG + a, f = i.previewCache.data, g = f.config[a],
                        ...
                        w = function (e, a, r, n, o, l, s, d) {
                            var c = " file-preview-initial " + t.SORT_CSS + (s ? " " + s : ""),
                                u = i.previewInitId + "-" + t.INIT_FLAG + l, p = g && g.fileId || u;
            ...
            if (o && o.content && (n = o.content.length), a.showPreview) {
                if (a.previewCache.set(r.content, r.config, r.tags, r.append), n) {
                    ...
                    a.initialPreview = t.cleanArray(o.content), a.initialPreviewConfig = t.cleanArray(o.config),
                        a.initialPreviewThumbTags = t.cleanArray(o.tags)
            ...
            var n, o, l, s, d, c, u, p, f, g, m, v, h, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                ...
                T = w.ajaxOperations.uploadThumb, I = b.getFile(a), P = {id: y, index: i, fileId: a},
                F = w.fileManager.getFileName(a, !0);
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(P) || (h = function () {
                ...
                f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function () {
                    r && h(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), e.extend(!0, P, w._getOutData(C, t)), w._setProgress(101, u, w.msgAjaxProgressError.replace("{operation}", T)), w._setProgress(101, o.find(".file-thumb-progress"), w.msgUploadError), w._showFileError(f, P)
                }, w.processDelay)
            }, C.append(w.uploadFileAttr, I.file, F), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, g, m, v, C, a, i)))
            ...
            i._initZoomButton(), a.find(n).each(function () {
                ...
                if (!t.isEmpty(f) && void 0 !== g) {
                    ...
                    x = parseInt(x.replace(t.INIT_FLAG, "")), w = t.isEmpty(y.config) && t.isEmpty(y.config[x]) ? null : y.config[x], _ = t.isEmpty(w) || t.isEmpty(w.extra) ? r : w.extra, b = w.filename || w.caption || "", "function" == typeof _ && (_ = _()), h = {
                        id: p.attr("id"),
                        key: g,
                        extra: _
                    }, o = function (e) {
                        ...
                        return t.isEmpty(e) || t.isEmpty(e.error) ? (C.removeClass("file-uploading").addClass("file-deleted"), void C.fadeOut("slow", function () {
                            x = parseInt(C.attr("data-fileindex").replace(t.INIT_FLAG, "")), i.previewCache.unset(x), i._deleteFileIndex(C), c = i.previewCache.count(!0), u = c > 0 ? i._getMsgSelected(c) : "", i._setCaption(u), i._raise("filedeleted", [g, o, _]), t.cleanZoomCache(a.find("#zoom-" + C.attr("id"))), i._clearObjects(C), C.remove(), d()
            ...
            var v, h, w, b = this, _ = b.slug(r), C = "", y = "",
                ...
                I = _, P = "type-default", F = u || b._renderFileFooter(i, _, d, "auto", s), E = b.preferIconicPreview,
                k = b.preferIconicZoomPreview, S = E ? "other" : i;
            return h = 400 > x ? b.previewSettingsSmall[S] || b.defaults.previewSettingsSmall[S] : b.previewSettings[S] || b.defaults.previewSettings[S], h && e.each(h, function (e, t) {
                y += e + ":" + t + ";"
            }), w = function (a, s, d, u) {
                ...
                return b.frameClass && (h = b.frameClass + " " + h), d && (h = h.replace(" " + t.SORT_CSS, "")), v = b._parseFilePreviewIcon(v, r), "text" === a && (s = t.htmlEncode(s)), "object" !== i || n || e.each(b.defaults.fileTypeSettings, function (e, t) {
                    "object" !== e && "other" !== e && t(r, n) && (P = "type-" + e)
            ...
            }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(k ? "other" : i, m ? m : a, !0, "kv-zoom-thumb")), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), v = w(E ? "other" : i, a, !1, "kv-preview-thumb"), v + C
        }, _addToPreview: function (e, t) {
            var i = this;
            return i.reversePreviewOrder ? e.prepend(t) : e.append(t)
        }, _previewDefault: function (i, a) {
            var r = this, n = r.$preview;
            if (r.showPreview) {
                var o, l = t.getFileName(i), s = i ? i.type : "", d = i.size || 0, c = r._getFileName(i, ""),
                    u = a === !0 && !r.isAjaxUpload, p = t.createObjectURL(i), f = r.fileManager.getId(i),
                    g = r._getThumbId(f);
                r._clearDefaultPreview(), o = r._generatePreviewTemplate("other", p, l, s, g, f, u, d), r._addToPreview(n, o), r._setThumbAttr(g, c, d), a === !0 && r.isAjaxUpload && r._setThumbStatus(e("#" + g), "Error")
            }
            ...
            if (this.showPreview) {
                ...
                var h = p.find("#" + v), w = h.find("img"), b = h.attr("data-fileid");
                l._validateImageOrientation(w, i, v, b, c, d, f, g), l._setThumbAttr(v, c, f), l._initSortable()
            }
            ...
            var o, l, s, d, c, u, p, f, g, m, v = this, h = e(a.img)[0], w = h.naturalWidth, b = h.naturalHeight, _ = 1,
                ...
                I = v.imageCanvasContext, P = a.typ, F = a.pid, E = a.ind, k = a.thumb, S = a.exifObj;
            if (c = function (e, t, i) {
                v.isAjaxUpload ? v._showFileError(e, t, i) : v._showError(e, t, i), v._setPreviewError(k)
            }, f = v.fileManager.getFile(i), g = {
                id: F,
                index: E,
                fileId: i
            }, m = [i, F, E], (!f || !x || C >= w && y >= b) && (x && f && v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized"), !x)) return void c(v.msgImageResizeError, g, "fileimageresizeerror");
            ...
            try {
                I.drawImage(h, 0, 0, w, b), d = T.toDataURL(P, v.resizeQuality), S && (p = window.piexif.dump(S), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), v.fileManager.setFile(i, o), v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(v.msgImageResizeError, g, "fileimageresizeerror")
            } catch (A) {
            ...
            t._getThumbs().each(function () {
                ...
                "-1" !== r && -1 !== r && (t.fileManager.getFile(a.attr("data-fileid")) ? a.attr({"data-fileindex": "-1"}) : (a.attr({"data-fileindex": i}), i++), t.$preview.find("#zoom-" + n).attr({"data-fileindex": a.attr("data-fileindex")}))
            })
            ...
            var a, r = this, n = r.$element, o = r.reader, l = r.$previewContainer, s = r.$previewStatus,
                ...
                w = t.isEmpty(h) ? "" : h.join(", "), b = function (t, n, o, l, s) {
                    ...
                    r._previewDefault(n, !0), r.isAjaxUpload ? setTimeout(function () {
                        a(l + 1)
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                var C, y, x, T, I, P, F, E, k, S, A, z, D, M, $ = g + _, U = u + "-" + $, j = i[_], R = f.text,
                    O = f.image, B = f.html, L = r._getFileName(j, ""), N = (j && j.size || 0) / 1e3, Z = "",
                    H = t.createObjectURL(j), W = 0, q = "", V = 0, G = function () {
                ...
                if (j) {
                    if (k = r.fileManager.getId(j), v > 0) for (y = 0; v > y; y++) F = m[y], E = r.msgFileTypes[F] || F, q += 0 === y ? E : ", " + E;
                    if (L === !1) return void a(_ + 1);
                    if (0 === L.length) return x = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(j), "[unknown]")), void b(x, j, U, _, k);
                    if (t.isEmpty(h) || (Z = new RegExp("\\.(" + h.join("|") + ")$", "i")), C = N.toFixed(2), r.maxFileSize > 0 && N > r.maxFileSize) return x = r.msgSizeTooLarge.setTokens({
                        name: L,
                        size: C,
                        maxSize: r.maxFileSize
                    }), void b(x, j, U, _, k);
                    if (null !== r.minFileSize && N <= t.getNum(r.minFileSize)) return x = r.msgSizeTooSmall.setTokens({
                        name: L,
                        size: C,
                        minSize: r.minFileSize
                    }), void b(x, j, U, _, k);
                    if (!t.isEmpty(m) && t.isArray(m)) {
                        for (y = 0; y < m.length; y += 1) I = m[y], S = f[I], W += S && "function" == typeof S && S(j.type, t.getFileName(j)) ? 1 : 0;
                        if (0 === W) return x = r.msgInvalidFileType.setTokens({
                            name: L,
                            types: q
                        }), void b(x, j, U, _, k)
                    }
                    if (0 === W && !t.isEmpty(h) && t.isArray(h) && !t.isEmpty(Z) && (P = t.compare(L, Z), W += t.isEmpty(P) ? 0 : P.length, 0 === W)) return x = r.msgInvalidFileExtension.setTokens({
                        name: L,
                        extensions: w
                    }), void b(x, j, U, _, k);
                    if (r.isAjaxUpload && r.fileManager.exists(k)) return x = r.msgDuplicateFile.setTokens({
                        name: L,
                        size: C
                    }), b(x, j, U, _, k), T = e("#" + U), void(T && T.length && T.remove());
                    if (!r._canPreview(j)) return r.isAjaxUpload && r.fileManager.add(j), r.showPreview && (l.addClass("file-thumb-loading"), r._previewDefault(j), r._initFileActions()), void setTimeout(function () {
                    ...
                    A = R(j.type, L), z = B(j.type, L), D = O(j.type, L), s.html(d.replace("{index}", _ + 1).replace("{files}", p)), l.addClass("file-thumb-loading"), o.onerror = function (e) {
                        ...
                        var a, n, l, s, d, c, u = [], p = function (e) {
                            ...
                            t.onerror = function (e) {
                                ...
                                r._previewFile(_, j, e, H, n), r._initFileActions(), G()
                        ...
                        r._previewFile(_, j, i, H, n), r._initFileActions(), G()
